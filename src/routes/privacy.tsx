			...
			<div class={styles.main}>
				<div class={styles.content}>
					...
					<ul>
						...
						<li>
							<p>
								<strong>Country</strong> refers to: New Jersey,
								United States
							</p>
						</li>
						<li>
						...
						<li>
							<p>
								<strong>Website</strong> refers to Baddle,
								accessible from{' '}
								<a
									href="https://baddle.ga"
					...
					<ul>
						...
						<li>
							<p>
								...
								by email or other equivalent forms of electronic
					...
					<ul>
						<li>
							<p>By email: oliverwu@chatham-nj.org</p>
						</li>
						<li>
							<p>
								By visiting this page on our website:{' '}
								<a
									href="https://baddle.ga/contact"
									rel="external nofollow noopener"
									target="_blank">
									https://baddle.ga/contact
								</a>
							</p>
						</li>
					</ul>
